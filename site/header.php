...
<link rel="alternate" type="text/xml+oembed" href="https://www.donatelife.net/wp-json/oembed/1.0/embed?url=https%3A%2F%2Fwww.donatelife.net%2Ftypes-of-donation%2F&#038;format=xml" />
...
<script type="text/javascript">
	dataLayer.push({"pagePostType":"page","pagePostType2":"single-page","pagePostAuthor":"DonateLifeAmerica"});
</script><style type="text/css" id="wpforge-customizer-css">
...
<body class="home page page-id-41 page-template page-template-page-templates page-template-default-no-overlay page-template-page-templatesdefault-no-overlay-php full-width front-page wpb-js-composer js-comp-ver-4.11.2.1 vc_responsive">
		...
		<div class="title-bar" data-responsive-toggle="main-menu" data-hide-for="large">
			...
			<div class="main-nav-menu-closed main-nav-submenu">
				<button type="button" data-toggle>
					<span class="genericon genericon-menu main-header-button main-header-button-closed"></span>
				</button>
				<div class="submenu-content submenu-content-hide">
				</div>
			</div>
		</div><!-- end title-bar -->
			...
			<div class="top-bar" id="main-menu">
				...
				<div class="top-bar-right">
					...
					<ul class="menu vertical medium-horizontal" data-responsive-menu="drilldown medium-dropdown" data-parent-link="true">
						<li id="menu-item-5" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-5"><a href="index.php">Understand Donation</a>
							<ul class="menu vertical nested">
								<li id="menu-item-70" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-70"><a href="index.php#31">True stories</a></li>
								<li id="menu-item-139" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-139"><a href="index.php#32">Types of Donation</a></li>
								<li id="menu-item-74" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-74"><a href="index.php#33">Myths and Facts</a></li>
						...
						<li id="menu-item-36" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-36"><a href="#">Donate</a>
							<ul class="menu vertical nested">
								...
								<li id="menu-item-156" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-156"><a href="how_to_help.php">How to help</a></li>
							</ul>
						</li>
						<li id="menu-item-38" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-has-children menu-item-38"><a href="#">About Us</a>
							<ul class="menu vertical nested">
								<li id="menu-item-130" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-130"><a href="mission-vision.php">Mission &#038; Vision</a></li>
								<li id="menu-item-6152" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-6152"><a href="contact.php">Contact Us</a></li>
							</ul>
						</li>
